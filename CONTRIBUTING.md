...
Thanks for your interest in this list!
...
Direct pull requests modifying `README.md` will not be merged — the file is regenerated daily from the SaaS Radar database, so any manual edits would be overwritten.
...
Reach out at [alexis@morain.fr](mailto:alexis@morain.fr).
